...
urlpatterns = [
    ...
    path("auth/admin_obtain_token", admin_obtain_jwt_token,
         name="admin_obtain_jwt_token"),
    path("auth/refresh_token", refresh_jwt_token, name="refresh_jwt_token"),

    # account apis
    path("user/get_user_simple_dict", get_user_simple_dict,
         name="get_user_simple_dict"),
    path("user/sign_up", sign_up, name="sign_up"),
    path("user/confirm_and_create", confirm_and_create,
         name="confirm_and_create"),
    path("user/forget_password", forget_password, name="forget_password"),
    ...
    path("user/change_avatar", change_avatar, name="change_avatar"),
    path("user/change_nickname", change_nickname, name="change_nickname"),

    # user profile apis
    path("user/follow", follow),
    path("user/get_user_following_num", get_user_following_num,
         name="get_user_following_num"),
    ...
    path("user/get_published_prompt_num", get_published_prompt_num,
         name="get_published_prompt_num"),
    path("user/get_published_prompt_list", get_published_prompt_list,
         name="get_published_prompt_list"),
    path("user/get_audit_record_list", get_audit_record_list,
         name="get_audit_record_list"),
    path("user/delete_audit_record", delete_audit_record,
         name="delete_audit_record"),
    path("user/is_following", is_following, name="is_following"),

    # admin apis
    path("admin/get_user_list", admin.get_user_list, name="get_user_list"),
    ...
    path("admin/delete_comment", admin.delete_comment, name="delete_comment"),
    path("admin/audit_prompt", admin.audit_prompt, name="audit_prompt"),
    path("admin/get_prompt", admin.get_prompt, name="get_prompt"),

    # prompt apis
    path("prompt/create_prompt", create_prompt, name="create_prompt"),
    path("prompt/edit_prompt", edit_prompt, name="edit_prompt"),
    path("prompt/delete_prompt", delete_prompt, name="delete_prompt"),
    path("prompt/get_prompt", get_prompt, name="get_prompt"),
    path("prompt/get_editing_prompt", get_editing_prompt,
         name="get_editing_prompt"),

    # comment apis
    path("comment/create_comment", create_comment, name="create_comment"),
    path("comment/delete_comment", delete_comment, name="delete_comment"),
    path("comment/get_comment_list", get_comment_list, name="get_comment_list"),

    # history apis
    path("history/get_history_list", get_history_list, name="get_history_list"),
    path("history/delete_history", delete_history, name="delete_history"),
    ...
    path("collection/modify_collection", mod_collection, name="mod_collection"),
    ...
    path("collection/manage_collection_records", manage_collection_records,
         name="manage_collection_records"),
    ...
    path("notification/get_unread_notification_num",
         get_unread_notification_num, name="get_unread_notification_num"),

    # prompt_list
    path("prompt_list/search_prompt_keyword", search_prompt_keyword,
         name="search_prompt_keyword"),
    path("prompt_list/hot_prompt_list", hot_prompt_list,
         name="hot_prompt_list"),
    path("prompt_list/personized_prompt_list", personized_prompt_list,
         name="personalized_prompt_list"),

    # upload image
    path("image/get_qiniu_token", get_qiniu_token, name="get_qiniu_token")
